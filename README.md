# Employee Tracker
  ...
  ## Testing 
  How to test:
  They will Clone my repo. download all the dependencies with npm install, and then run node index, you will also have to create an .env file with your sql password defined aspassword.
